...
class TrainingStats:
    ...
    def __init__(self, model):
        ...
        self.fc_train = []      # mean correlation on training set
        self.fc_val   = []      # correlation on validation set
        self.grad_norm = []     # grad on model parameters
        self.lr_hist   = []     # learning rate of model-parameter group
    ...
    def appendFCTrain(self, val): self.fc_train.append(val)
    def appendFCVal(self,   val): self.fc_val.append(val)
    def appendGrad(self,    val): self.grad_norm.append(val)
    def appendLR(self,      val): self.lr_hist.append(val)
